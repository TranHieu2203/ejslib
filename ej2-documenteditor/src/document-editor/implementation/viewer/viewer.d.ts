...
export declare class DocumentHelper {
     ...
     * @returns {void}
     */
    removePage(page: Page, updateHeaderFooterPage?: boolean): void;
    /**
...
export declare abstract class LayoutViewer {
    ...
    findFocusedPage(currentPoint: Point, updateCurrentPage: boolean, updateHeaderFooterPage?: boolean, updatePage?: Page): Point;
    private updateHeaderFooterPageInstance;
