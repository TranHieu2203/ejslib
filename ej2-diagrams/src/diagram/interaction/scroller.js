...
var DiagramScroller = /** @class */ (function () {
     ...
     * @private
     */
    DiagramScroller.prototype.zoom = function (factor, deltaX, deltaY, focusPoint, isInteractiveZoomPan) {
    ...
    DiagramScroller.prototype.applyScrollLimit = function (hOffset, vOffset, isInteractiveZoomPan) {
        ...
        if (this.diagram.scrollSettings.scrollLimit !== 'Infinity') {
            var bounds = void 0;
            var allowedRight = void 0;
            var allowedBottom = void 0;
     ...
     */
    DiagramScroller.prototype.getOffset = function (offset, viewPort, bounds, isInteractiveZoomPan) {
